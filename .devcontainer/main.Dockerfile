...
RUN curl -qsL https://github.com/tailwindlabs/tailwindcss/releases/download/v3.3.3/tailwindcss-linux-$($([[ $(uname -a) =~ 'x86_64' ]] && echo -n 'amd64') || echo -n 'arm64') > /usr/local/bin/tailwindcss
